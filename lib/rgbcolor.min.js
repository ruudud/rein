...
function RGBColor(b) {
  ...
  d = [{re:/^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/, example:["rgb(123, 234, 45)", "rgb(255,234,245)"], process:function(a) {
  ...
  for(c = 0;c < d.length;c++) {
    var f = d[c].process, e = d[c].re.exec(b);
    e && (channels = f(e), this.r = channels[0], this.g = channels[1], this.b = channels[2], this.ok = !0)
  }
